...
<?php 
   ...
   // $mobile =  trim(strip_tags($_POST['btnupdate']));
    $uid=$_SESSION['uid'];
    list($fname,$lname,$mobile,$pid,$cid) = explode(":",$_POST['btnupdate']);
?>
<div class="container" style="max-width: 330px;">
    <form class="form-group" method="POST" action="php/update.php">
        ...
        <button class="btn btn-lg btn-primary btn-block" value=<?php echo $cid.":".$pid; ?> name="updatebtn"  type="submit">Update</button>
    </form>
</div>
